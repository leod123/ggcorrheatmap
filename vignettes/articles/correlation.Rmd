...
If complete control is needed, the `colr_scale` argument can be used to overwrite the default scale. This can be a string specifying a Brewer or Viridis scale, or a `ggplot2` scale project.
...
plt1 <- ggcorrhm(mtcars, colr_scale = "RdYlGn")

# Arguments like bins and limits still work with brewer and viridis scales
plt2 <- ggcorrhm(mtcars, colr_scale = "PuOr", bins = 5)

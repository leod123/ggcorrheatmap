...
The colours of the heatmap can be adjusted by passing a string specifying a Brewer or Viridis scale or a `ggplot2::scale_fill_*` function call to the `colr_scale` argument.

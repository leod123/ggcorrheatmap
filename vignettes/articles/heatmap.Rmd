...
By default, fill, colour and size scales are shown. A named logical vector, where the names are the aesthetics like 'fill' and 'size', can be passed to the `show_legend` argument to hide specific legends. Just `FALSE` hides all legends (besides annotation legends).

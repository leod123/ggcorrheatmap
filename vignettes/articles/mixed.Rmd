...
The arguments that work like this are `border_col`, `border_lwd`, `border_lty`, `cell_labels`, `cell_label_col`, `cell_label_size`, `cell_label_digits`, and (for `ggcorrhm`) `p_values`.
...
```{r}
ggcorrhm(mtcars, layout = c("tr", "bl"), p_values = c(FALSE, TRUE),
